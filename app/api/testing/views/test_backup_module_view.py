...
from api.views import BaseViewSet, CategoryViewSet, BackupViewSet, BackupModuleViewSet
from django.test import TestCase


class BackupModuleViewSetTest(TestCase):

    def setUp(self):
        self.view = BackupModuleViewSet()
