...
class BackupJob(BaseModel):
    ...
    backup_module_secrets = models.ManyToManyField('Secret', through="BackupJobSecret",
                                                   related_name="backup_job_secret")
    backup_module_parameters = models.ManyToManyField('Parameter', through="BackupJobParameter",
                                                      related_name="backup_job_parameter")
    ...
    storage_modules = models.ManyToManyField('StorageModule', through="BackupJobStorageModule",
                                             related_name="backup_job_storage_modules")
...
class BackupJobStorageModule(BaseModel):
    backup_job = models.ForeignKey(BackupJob, on_delete=models.CASCADE,
                                   related_name="backup_job_storage_module_backup_job")
    storage_module = models.ForeignKey('StorageModule', on_delete=models.CASCADE,
                                       related_name="backup_job_storage_module_storage_module")
    secrets = models.ManyToManyField('Secret', through="BackupJobStorageModuleSecret",
                                     related_name="backup_job_storage_module_secret")
    parameters = models.ManyToManyField('Parameter', through="BackupJobStorageModuleParameter",
                                        related_name="backup_job_storage_module_parameter")
    # to input a dict, without to need to create a whole parameter database entry
    ...
    encryption_secret = models.ForeignKey('Secret', null=True, blank=True,
                                          ...
                                          related_name="backup_job_storage_module_encryption_secret")
...
class BackupJobStorageModuleSecret(BaseModel):
    ...
    secret = models.ForeignKey('Secret', on_delete=models.CASCADE,
                               related_name="backup_job_storage_model_secret_secret")
...
class BackupJobStorageModuleParameter(BaseModel):
    ...
    parameter = models.ForeignKey('Parameter', on_delete=models.CASCADE,
                                  related_name="backup_job_storage_model_parameter_parameter")
